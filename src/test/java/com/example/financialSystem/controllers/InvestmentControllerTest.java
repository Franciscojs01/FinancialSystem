...
//        int investmentId = 1;
//
//        when(investmentService.getInvestmentById(UUID.randomUUID())).thenReturn(investmentResponse);
//
...
//
//        when(investmentService.simulateInvestment(UUID.randomUUID(), anyInt())).thenReturn(investmentResponse);
//
